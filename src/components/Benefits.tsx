        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            <div className="w-14 h-14 bg-althea-100 rounded-full flex items-center justify-center mb-4">
              <Clock className="w-7 h-7 text-althea-600" />
            </div>
            <h3 className="text-xl font-semibold text-althea-800 mb-2">Agilidad</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            <div className="w-14 h-14 bg-althea-100 rounded-full flex items-center justify-center mb-4">
              <Percent className="w-7 h-7 text-althea-600" />
            </div>
            <h3 className="text-xl font-semibold text-althea-800 mb-2">Tasas Competitivas</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            <div className="w-14 h-14 bg-althea-100 rounded-full flex items-center justify-center mb-4">
              <UserPlus className="w-7 h-7 text-althea-600" />
            </div>
            <h3 className="text-xl font-semibold text-althea-800 mb-2">Asesoría Personalizada</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            <div className="w-14 h-14 bg-althea-100 rounded-full flex items-center justify-center mb-4">
              <Key className="w-7 h-7 text-althea-600" />
            </div>
            <h3 className="text-xl font-semibold text-althea-800 mb-2">Acceso Exclusivo</h3>
            <p className="text-gray-600">
