    ...
    <section id="beneficios" className="bg-white py-16">
      <div className="section-container">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Por qué arrendar tu equipo con Althea Lease?</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            ...
            <h3 className="text-xl font-semibold mb-2">Agilidad</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            ...
            <h3 className="text-xl font-semibold mb-2">Tasas Competitivas</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md card-hover">
            ...
            <h3 className="text-xl font-semibold mb-2">Acceso Exclusivo</h3>
            <p className="text-gray-600">
